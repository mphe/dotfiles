...
local systemmenu = {
    utils.menu_entry("Lock", home .. "/scripts/lockscreen.sh", "actions/system-lock-screen"),
    utils.menu_entry("Poweroff", "systemctl poweroff", "actions/system-shutdown"),
    utils.menu_entry("Reboot", "systemctl reboot", "actions/system-reboot"),
    utils.menu_entry("Suspend", "systemctl suspend", "actions/system-suspend"),
    utils.menu_entry("Hibernate", "systemctl hibernate", "actions/system-hibernate"),
}
...
local mymainmenu = freedesktop.menu.build({
    ...
    after = {
        ...
        utils.menu_entry("System Monitor", "xfce4-taskmanager", "apps/utilities-system-monitor"),
        utils.menu_entry("Kill Process", home .."/scripts/killprompt.sh"),
        utils.menu_entry("Screenshot", "xfce4-screenshooter", "apps/accessories-screenshot"),
        ...
        { "Restart udiskie", function() awful.spawn.with_shell("killall udiskie; sleep 1; udiskie") end },  -- luacheck: ignore
    }
})
